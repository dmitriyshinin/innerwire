# Источники: Интероцептивный профиль

Полный список источников с аннотациями и рекомендованным порядком чтения (при наличии) -> [research/bibliography.md](../../../research/bibliography.md)

## Ключевые работы

### Интероцепция: фундаментальная теория

- **Craig, A. D. (2009).** How do you feel — now? The anterior insular cortex and human awareness. *Nature Reviews Neuroscience, 10*(1), 59–70.
...
### Модель трёх измерений (точность, чувствительность, осведомлённость)
...
### Измерение: MAIA и распознавание сердцебиения

- **Mehling, W. E., Acree, M., Stewart, A., Silas, J., & Jones, A. (2018).** The Multidimensional Assessment of Interoceptive Awareness (MAIA). *PLoS ONE, 7*(11), e48230.
...
### Интероцептивная тренировка и улучшение
...
- **Ring, C., & Brener, J. (2018).** Heartbeat counting is unrelated to heartbeat detection: A comparison of methods to quantify interoception. *Psychophysiology, 55*(9), e13084.

- **Desmedt, O., Luminet, O., & Corneille, O. (2018).** The Heartbeat Counting Task largely measures non-interoceptive processes: Better alternatives to measure interoception. *Biological Psychology, 144*, 68–78.
...
InnerWire стремится к максимальной научной честности:

- Мы ссылаемся на рецензируемые публикации
- Мы приводим критику наряду с подтверждающими исследованиями
- Если утверждение основано на предварительных данных, мы это отмечаем
- Модель будет обновляться по мере появления новых исследований

Область интероцепции активно развивается. Ключевые дебаты (особенно вокруг методов измерения) остаются неразрешёнными. Мы представляем модель трёх измерений как лучшую доступную рамку, а не как устоявшуюся науку.

Нашли ошибку или знаете релевантное исследование? Пожалуйста, [откройте issue](../../../CONTRIBUTING.md).
